...
<article class="wow fadeIn animated hover-up mb-30 animated">
    <div class="post-thumb" style="background-image: 
    url({{ asset("storage/$post->post_image")  }})">
    ...
    $posts = App\Models\BlogPost::where('category_id',$category->id)->get();
            ...
            <li>
                <a href="{{ url('post/category/'.$category->id.'/'.$category->slug) }}"> <img src="{{ asset('frontend/assets/imgs/theme/icons/category-1.svg') }}" alt="" />{{ $category->name }}</a><span class="count">{{ count($posts) }}</span>
            </li>
            @endforeach
        </ul>
                            </div>
