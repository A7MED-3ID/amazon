    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span></span> <a href={{route('category.products',[$product->category->id,$product->category->name])}}>{{$product['category']['name']}}</a><span></span> {{$product['subcategory']['name']}} <span></span> {{$product->name}}
            </div>
        </div>
    </div>
                            ...
                            <div class="detail-gallery">
                                ...
                                <div class="product-image-slider">
                                    ...
                                    <figure class="border-radius-10">
                                        <img src={{asset("storage/$img->photo_name")}} alt="product image" />
                                    </figure>
                                    @endforeach
                                ...
                                <div class="slider-nav-thumbnails">
                                    ...
                                    <div><img src={{asset("storage/$img->photo_name")}} alt="product image" /></div>
                                    @endforeach
                        ...
                        @if($product->discount_price == 0)
                            ...
                            <div class="product-price primary-color float-left">
                                ...
                                <div class="attr-detail attr-size mb-30">
                                    <strong style="width:50px" class="mr-10">Size : </strong>
                                    <select id="dsize" class="form-control unicase-form-control" name="size" id="size">
                                ...
                                @else
                                <div class="attr-detail attr-size mb-30">
                                    <strong style="width:50px" class="mr-10">Color : </strong>
                                    <select id="dcolor" class="form-control unicase-form-control" name="color" id="size">
                                ...
                                <input type="hidden" value={{$product->vendor_id}} id="vproduct_id">

                            <button onclick="addToCartDetails()" type="submit" class="button button-add-to-cart"><i class="fi-rs-shopping-cart"></i>Add to cart</button>
...
<ul class="float-start">
    ...
    <li>Stock:<span class="in-stock text-brand ml-5">({{$product->quantity}}) Items In Stock</span></li>
        ...
        <img src={{ (!empty($product['vendor']['photo'])) ? 
        url("storage/".$product->vendor->photo):url('storage/vendor/no_image.jpg') }}  />
            ...
            @php
                $reviews = App\Models\Review::where("product_id",$product->id)->where("status","!=",0)->latest()->limit(5)->get();
            @endphp
                                ...
                                <div class="single-comment justify-content-between d-flex mb-30">
                                    <div class="user justify-content-between d-flex">
                                        <div class="thumb text-center">
                                            <img src={{ (!empty($review->user->photo)) ? url('/storage/'.$review->user->photo):url('/storage/user/no_image.jpg') }} alt="" />
        ...
        @guest
        <p><b>For Add Product Review. You Need To Login First <a href={{route('login')}}>Login Here</a></b>
        </p>
       ...
       <form class="form-contact comment_form" action={{ route('store.review',$product->id) }} method="post" id="commentForm">
        @csrf
        ...
        <div class="product-cart-wrap hover-up">
            <div class="product-img-action-wrap">
                ...
                <div class="product-action-1">
                    <a aria-label="Quick view" class="action-btn small hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal" id={{$product->id}} onclick="productView(this.id)"><i class="fi-rs-search"></i></a>
                    ...
                    <a aria-label="Compare" class="action-btn small hover-up"  id={{$product->id}} onclick="addToCompare(this.id)" tabindex="0"><i class="fi-rs-shuffle"></i></a>
                </div>
