...
@section('title')
 {{$current_subcat['category']['name']}} > {{$current_subcat->name}} SubCategory
        ...
        <div class="container">
            <div class="archive-header">
                <div class="row align-items-center">
                    <div class="col-xl-3">
                        <h5 class="mb-15">{{$current_subcat->name}}</h5>
                        <div class="breadcrumb">
                            <a href={{url('/')}} rel="nofollow"><i class="fi-rs-home mr-5"></i>Home</a>
                            <span></span>
                            <a href={{url("category/products/".$current_subcat['category']['id']."/".$current_subcat['category']['slug'])}} rel="nofollow">{{$current_subcat['category']['name']}}</a>
                            
                             <span></span>{{$current_subcat->name}} 
                        </div>
                    </div>
            ...
            <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
                <div class="sidebar-widget widget-category-2 mb-30">
                    ...
                    <ul>
                        ...
                        @php
                            $num_products =App\Models\Product::where("subcategory_id",$subcategory->id)->get();
                        @endphp
                            
                        <li>
                            <a href={{route('subcategory.products',[$subcategory->id,$subcategory->slug])}}> <img src={{asset("storage/$subcategory->image")}} alt="" />{{$subcategory->name}}</a><span class="count">{{count($num_products)}}</span>
                        </li>
                    ...
                    <div class="single-post clearfix">
                        ...
                        @if($new_product->discount_price == 0)
                            ...
                            <div class="product-rate">
                                @php
                                $avgRating = App\Models\Review::where("product_id",$new_product->id)->where("status","!=",0)->avg('rating');
                    
                                $reviews = App\Models\Review::where("product_id",$new_product->id)->where("status","!=",0)->get();
