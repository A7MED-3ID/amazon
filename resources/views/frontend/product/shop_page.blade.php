                ...
                <div class="product-img product-img-zoom">
                    <a href="{{ url('product/details/'.$product->id.'/'.$product->slug) }}">
                        <img class="default-img" src="{{ 
                            asset("storage/".$product->product_thambnail ) }}" alt="" />
...
@endphp
    ...
    <div class="custome-checkbox">
        ...
        <label class="form-check-label" for="exampleCheckbox{{ $category->id }}"><span>{{ $category->name }} ({{ count($products) }})</span></label>
...
@endforeach
   ...
   <div class="custome-checkbox">
        <input class="form-check-input" type="checkbox" name="brand[]" id="exampleBrand{{ $brand->id }}" value="{{ $brand->slug }}" @if(!empty($filterBrand) && in_array($brand->slug,$filterBrand)) checked @endif  onchange="this.form.submit()" />
    ...
    @endforeach
        ...
        <div class="single-post clearfix">
            <div class="image">
                <img src="{{ asset("storage/".$product->product_thambnail ) }}" alt="#" />
            </div>
