...
<div class="row">
    <div class="form-group col-md-6">
        ...
        <input required="" class="form-control" name="username" type="text" value="{{ $userData->name }}" />
    </div>
    <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-12">
      ...
      <div class="form-group col-md-12">
        ...
        <img id="showImage" src="{{ (!empty($userData->photo)) ? url('/storage/'.$userData->photo):url('/storage/user/no_image.jpg') }}" alt="User" class="rounded-circle p-1 bg-primary" width="110">
    </div>
