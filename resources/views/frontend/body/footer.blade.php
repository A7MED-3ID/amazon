                ...
                <div class="col">
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <div class="logo mb-30">
                            <a href="/" class="mb-15"><img src={{asset("storage/".$setting->logo)}} alt="logo" /></a>
                            <p class="font-lg text-heading">Awesome grocery store website E-Commerce</p>
                        </div>
                        <ul class="contact-infor">
                            <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-location.svg') }}" alt="" /><strong>Address: {{$setting->company_address}} </strong> <span>  </span></li>
                            <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-contact.svg') }}" alt="" /><strong>Call Us: {{$setting->phone_one}}</strong><span></span></li>
                            <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-email-2.svg') }}" alt="" /><strong>Email: {{$setting->email}}</strong><span></span></li>
    ...
    <div class="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0">
        <div class="row align-items-center">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <p class="font-sm mb-0"><strong class="text-brand">Ecommerce</strong> - {{$setting->copyright}}</p>
            </div>
