     ...
     <div class="header-action-icon-2">
        ...
        <a href="{{ route('compare') }}"><span class="lable ml-0">Compare</span></a>
                            ...
                            <div class="header-action-icon-2">
                                ...
                                @else
                                <ul>
                                    <li style="font-weight:900; margin:10px">
                        ...
                        <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
                            <div class="d-flex categori-dropdown-inner">
                              <ul>
                                ...
                                @if($loop->index <5)
                                <li>
                                    <a href={{url("category/products/$category->id/$category->slug")}}> <img src={{asset("storage/$category->image")}} alt="" />{{$category->name}}</a>
                                </li>
                                    @endif
                                @endforeach
...
@endphp
                   @foreach ($categories as $category)
                                ...
                                <li>
                                    <a href={{url("category/products/$category->id/$category->slug")}}>{{$category->name}} <i class="fi-rs-angle-down"></i></a>
                                    <ul class="sub-menu">
            @php
            ...
            @endphp
                   @foreach ($subcategories as $subcategory)
                        ...
                        <li><a href={{url("subcategory/products/$subcategory->id/$subcategory->slug")}}>{{$subcategory->name}}</a></li>
                        @endforeach
