                    ...
                    <div class="vendor-wrap mb-40">
                        <div class="vendor-img-action-wrap">
                            <div class="vendor-img">
                             ...
                             <img src={{(!empty($vendor->photo)) ? 
                            url("storage/".$vendor->photo):url('storage/vendor/no_image.jpg') }}  alt="Vendor Image" style="width:120px; height:120px" />
                                </a>
                            </div>
                        ...
                        <div class="vendor-content-wrap">
                            <div class="d-flex justify-content-between align-items-end mb-30">
                                ...
                                <div class="mb-10">
                                    @php
                                        $vendor_products =App\Models\Product::where("vendor_id",$vendor->id)->get();
                                    @endphp
                                    <span class="font-small total-product">{{count($vendor_products)}} products</span>
                                </div>
                            </div>
