    ...
    <form method="post" action={{route('checkout.store')}}>
            ...
            <div class="form-group col-lg-6">
                <input type="email" required="" name="shipping_email" value={{Auth::user()->email}}>
                       ...
                       <div class="row shipping_calculator">
                            ...
                            <div class="form-group col-lg-6">
                                <input required="" type="shipping_address" name="city" value={{Auth::user()->address}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-30">
                            <textarea name="notes" rows="5" placeholder="Additional information"></textarea>
                        </div>
        ...
        <div class="table-responsive order_table checkout">
            ...
            <tr>
                ...
                src={{asset("/storage/".$cart->options->image)}} alt="#" 
                ...
                <div class="payment ml-30">
                    ...
                    <div class="payment_option">
                        <div class="custome-radio">
                            <input value="stripe" class="form-check-input" required="" type="radio" name="payment_option" id="exampleRadios3" checked="">
                        ...
                        <div class="custome-radio">
                            <input value="cash" class="form-check-input" required="" type="radio" name="payment_option" id="exampleRadios4" checked="">
                            <label class="form-check-label" for="exampleRadios4" data-bs-toggle="collapse" data-target="#checkPayment" aria-controls="checkPayment">Cash on delivery</label>
                        </div>
                        <div class="custome-radio">
                            <input value="card" class="form-check-input" required="" type="radio" name="payment_option" id="exampleRadios5" checked="">
