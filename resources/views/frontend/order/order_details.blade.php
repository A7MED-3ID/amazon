...
<!--  // End Return Order Option  -->
        ...
        {{-- <img src={{public_path("/storage/".$item->product->product_thambnail)}}>


        <img 
        
        src={{public_path("storage\\".str_replace("/","\\",$item->product->product_thambnail))}} >


        {{public_path("storage\\".$item->product->product_thambnail) }} --}}
