...
<script type="text/javascript">
    ...
    function productView(id){
        ...
        $.ajax({
            ...
            $('#pimage').attr('src','/storage/'+data.product.product_thambnail );
...
<script type="text/javascript">
    ...
    function miniCart(){
       $.ajax({
        ...
        //    product/details/${value.id}/${value.name}
              ...
              miniCart += ` <ul>
               <li>
                   <div class="shopping-cart-img">
                       <a href="#"><img alt="Nest" 
                        src="/storage/${value.options.image}" style="width:50px;height:50px;" /></a>
                   </div>
...
<script type="text/javascript">
    ...
    function wishlist(){
     ...
     rows += `<tr class="pt-30">
                    ...
                    <td class="image product-thumbnail pt-40"><img src="/storage/${value.product.product_thambnail}" alt="#" /></td>
...
<td class="row_img"><img src="/storage/${value.product.product_thambnail} " style="width:300px; height:300px;"  alt="compare-img" /></td>
