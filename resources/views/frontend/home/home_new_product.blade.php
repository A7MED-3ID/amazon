...
@php
$products =  App\Models\Product::where("status","active")->orderBy("id","ASC")->limit(10)->get();
$categories =  App\Models\Category::orderBy("name","ASC")->limit(10)->get();
               ...
               <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                ...
                src= {{asset("storage/$product->product_thambnail")}} alt="" />
                        ...
                        <div class="product-action-1">
                            ...
                            <a id={{$product->id}} onclick="addToCompare(this.id)" aria-label="Compare" class="action-btn" ><i class="fi-rs-shuffle"></i></a>
                            <a aria-label="Quick view" class="action-btn" data-bs-toggle="modal" data-bs-target="#quickViewModal" id={{$product->id}} onclick="productView(this.id)"><i class="fi-rs-eye"></i></a>
                        </div>
