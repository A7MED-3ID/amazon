                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src={{ (!empty($vendor->photo)) ? url("storage/$vendor->photo"):url('storage/vendor/no_image.jpg') }} alt="Vendor" class="rounded-circle p-1 bg-primary" width="110">
                                <div class="mt-3">
                                    <h4>{{$vendor->name}}</h4></h4>
                                    <p class="text-secondary mb-1">{{$vendor->user_name}}</p>
                          ...
                          <form action={{route('vendor.profile.update')}} method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input  name="user_name" disabled type="text" class="form-control" value={{$vendor->user_name}} />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input name="email" type="text" class="form-control" value={{$vendor->email}} />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input name="phone" type="text" class="form-control" value={{$vendor->phone}} />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <textarea name="vendor_short_info" class="form-control" placeholder="Vendor Info" rows="3">{{ $vendor->vendor_short_info }}
                                    </textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                     <img id="showImage" src="{{ (!empty($vendor->photo)) ? url("storage/$vendor->photo"):url('storage/vendor/no_image.jpg') }}" alt="vendor" style="width:100px; height: 100px;"  >
                                </div>
                            </div>
