                            ...
                            <div class="col-lg-8">
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input id="main" name="product_thambnail" class="form-control" type="file"
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        <input name="hot_deals" id="hot_deals" class="form-check-input"
                                                            type="checkbox" value="1">
                                                        <label for="hot_deals" class="form-check-label"
                                                            for="flexCheckDefault">Hot Deals</label>
                                                    </div>
