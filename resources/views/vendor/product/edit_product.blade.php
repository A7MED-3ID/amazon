...
<div class="page-content">
  ...
  <div class="card">
      <div class="card-body p-4">
          ...
          action={{route('vendor.update.product',$product->id)}} >
            @csrf
            @method('put')
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <div class="col-12">
                       <div class="row g-3">
                        ...
                        <div class="col-md-6">
                          <div class="form-check">
                            <input name="special_offer" class="form-check-input" type="checkbox"  id="special_offer" value="1"
                        ...
                        <div class="col-md-6">
                          <div class="form-check">
                            <input name="special_deals" class="form-check-input" type="checkbox" id="special_deals" value="1"
...
<div class="page-content">
  ...
  <div class="card">
    ...
    <form action={{route('vendor.update.product.thambnail',$product->id)}} method="post" enctype="multipart/form-data">
      @csrf
      @method('put')
...
<div class="card">
  <div class="card-body">
    <table class="table mb-0 table-striped">
      ...
      <tbody>
        <form method="post" action="{{ route('vendor.update.product.multiImg',$product->id) }}" enctype="multipart/form-data" >
          @csrf
          @method('put')
