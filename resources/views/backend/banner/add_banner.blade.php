        ...
        <div class="main-body">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                          <form id="myForm" action={{route('banner.add.store')}} method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                     <img id="showImage" src="{{url('storage/banner/no_image.jpg') }}" alt="image" style="width:100px; height: 100px;"  >
                                </div>
                            </div>
