            ...
            <div class="card">
              ...
              <th><span class="badge rounded-pill bg-info">{{ $order->status }}</span></th>
                     ...
                     <tr>
                        ...
                        <a href={{route('pending-to-confirm',$order->id)}} class="btn btn-block btn-danger" id="confirm">Confirm Order</a>
                            
                        @elseif($order->status == "confirmed")
                        <a href={{route('confirm-to-processing',$order->id)}} class="btn btn-block btn-danger" id="processing">Processing Order</a>

                        @elseif($order->status == "processing")

                        <a href={{route('processing-to-delivered',$order->id)}} class="btn btn-block btn-danger" id="delivered">Delivered Order</a>
                        ...
                        <tbody>
                            ...
                            @foreach($orderItem as $item)
                             <tr>
                                <td class="col-md-1">
                                    <label><img src="{{
                                         asset("/storage/".$item->product->product_thambnail) }}" style="width:50px; height:50px;" > </label>
                                </td>
                                <td class="col-md-2">
