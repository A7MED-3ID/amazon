...
<div class="col-lg-8">
	<div class="card">
		...
		<form method="post" action="{{ route('site.setting.update',$setting->id) }}" enctype="multipart/form-data" >
			@csrf
...
<div class="row mb-3">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					 <img id="showImage" src="{{ asset("/storage/".$setting->logo)   }}" alt="Admin" style="width:100px; height: 100px;"  >
				</div>
			</div>
