		 ...
		 <div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
					<select name="category_id" class="form-select" id="inputVendor">
						...
						<option value="{{ $cat->id }}" {{ $cat->id == $blogpost->category_id ? 'selected' : '' }} >{{ $cat->name }}</option>
						 @endforeach
					  </select>
				</div>
			</div>
...
<div class="row mb-3">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					 <img id="showImage" 
					 src={{ asset("/storage/$blogpost->post_image") }} alt="Admin" style="width:100px; height: 100px;"  >
				</div>
			</div>
