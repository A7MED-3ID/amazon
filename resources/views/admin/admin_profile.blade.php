                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src={{ (!empty($admin->photo)) ? url("storage/$admin->photo"):url('storage/admin/no_image.jpg') }} alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                <div class="mt-3">
                                    <h4>{{$admin->name}}</h4></h4>
                                    <p class="text-secondary mb-1">{{$admin->user_name}}</p>
                          ...
                          <form action={{route('admin.profile.update')}} method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input  name="user_name" disabled type="text" class="form-control" value={{$admin->user_name}} />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                     <img id="showImage" src="{{ (!empty($admin->photo)) ? url("storage/$admin->photo"):url('storage/admin/no_image.jpg') }}" alt="Admin" style="width:100px; height: 100px;"  >
                                </div>
                            </div>
